...
preference overrides it. Nunito is loaded as a variable font from Google Fonts,
with a system sans-serif fallback if that request is unavailable. The transparent
blue logo is derived from the untouched source with its original geometry
preserved exactly.
